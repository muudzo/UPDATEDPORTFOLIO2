    ...
    return (
        ...
        >
            ...
            <div className="w-[60%] m-[5px] mr-0 bg-white border border-[#7f9db9] rounded-sm relative flex flex-col shadow-inner">
                <div className="flex-1 overflow-y-auto p-2 scrollbar-win7">
                    {/* Pinned Programs will go here in next commit */}
                    <div className="text-gray-500 text-xs text-center mt-10">Programs...</div>
                </div>
            ...
            <div className="flex-1 p-[10px] flex flex-col gap-[2px] text-[#1e1e1e] text-[13px] leading-tight">
                {/* Custom text-shadow needed for Win7 look on glass */}
                <div style={{ textShadow: '0 0 5px rgba(255,255,255,0.8)' }} className="flex flex-col gap-[4px] font-medium text-[#1e1414]">
                    ...
                    <div className="cursor-pointer">Devices and Printers</div>
                    <div className="cursor-pointer">Default Programs</div>
                ...
                <div className="flex justify-end mt-2">
                    <button className="px-4 py-1 bg-gradient-to-b from-[#f2f2f2] to-[#cfd0d2] border border-[#8e8f90] rounded-[2px] text-xs hover:to-[#e0e0e0]">
                        Shut down
                    </button>
                </div>
            </div>
